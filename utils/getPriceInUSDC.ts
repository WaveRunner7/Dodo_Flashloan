...
export const getPriceInUSDC = async (params: PriceInUsdcParams) =>  {
    ...
    const pairAddresses = await factory.getPair(params.tokenAddress, ERC20Token.USDC?.address);
    const pair = new ethers.Contract(pairAddresses, pairAbi, params.provider);
