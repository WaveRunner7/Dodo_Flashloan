...
contract Flashloan is IFlashloan, DodoBase, FlashloanValidation, Withdraw {
    ...
    */
    function executeFlashloan(
        ...
        uint256 quoteAmount = IDODO(params.flashLoanPool)._QUOTE_TOKEN_()  == loanToken ? 0 : params.loanAmount;
    ...
    function _flashLoanCallBack(
        ...
        // Log the contract's balace of the loan token after repaying the loan.
        console.log(
        ...
        console.log(
            "LOAN_TOKEN CONTRACT BALANCE AFTER REPAY AND TRANSFER TO OWNER",
            IERC20(loanToken).balanceOf(address(this))
        );
    }
    ...
    */
    ...
    function dodoV2Swap(
        ...
        approveToken(path[1], dodoV2Pool, amountIn);

        (uint256 recievedQuoteAmount, ) = IDODOV2(dodoV2Pool).querySellBase(msg.sender, amountIn);
        uint256 minReturnAmount = recievedQuoteAmount * (100 - slippage) / 100;
